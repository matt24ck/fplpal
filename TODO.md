...
What's left to build, in priority order. Companion to [PLAN.md](PLAN.md) (the design), [UI_PLAN.md](UI_PLAN.md) (the interface spec), and [BUILDLOG.md](BUILDLOG.md) (what exists). Status as of 28 July 2026 — engine, API, grounded chat, and the full GW1-scope UI are built and verified; the GW1 deadline is **Fri 21 Aug 2026, 18:30 UTC**.
