...
*Remaining pre-launch: manual scoring-table verification (flip `verified_against_game`); hourly snapshot task registration (command in README). UI backlog per UI_PLAN §12: dark mode, live mode, drag-and-drop, comparison pinning, ownership overlay, chip timeline.*
