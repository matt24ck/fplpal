...
*Remaining pre-launch: execute the deploy (dashboard steps in DEPLOY.md); manual scoring-table verification (flip `verified_against_game`). UI backlog per UI_PLAN §12: dark mode, live mode, drag-and-drop, comparison pinning, ownership overlay, chip timeline.*
